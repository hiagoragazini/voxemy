                ...
                {filteredAgents.map((agent) => (
                  <div key={agent.id} className="border border-gray-200 rounded-lg p-5 hover:shadow-md transition-shadow">
                    ...
                    <div className="flex justify-between items-center mt-3 pt-3 border-t border-gray-100">
                      <Link href={`/agent/${agent.id}`} className="text-gray-600 hover:text-[#0F2D5A] text-sm flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <Link href={`/agent/${agent.id}/edit`} className="text-[#0F2D5A] hover:text-opacity-80 text-sm font-medium">
                        Editar
                      </Link>
                    </div>
                  </div>
